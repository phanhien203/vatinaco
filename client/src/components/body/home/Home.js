...
function Home() {
    ...
    useEffect(() => {
        if(isAdmin){
            const admin = window.open('/dashboard')
        }
    },[isAdmin])
    ...
    const overflow1 = {
        display: button1 ? "-webkit-box;" : "block"
    }

    const overflow2 = {
        display: button2 ? "-webkit-box;" : "block"
    }
    ...
    return (
        <div className="home_page" >
            <div className="nav_bar">
                ...
                <div className="menu">
                    <Link className="menu_item" to="/">MY FACTORY</Link>
                    <Link className="menu_item" to="/">COMMUNITY</Link>
                    <Link className="menu_item" to="/">ABOUT</Link>
                </div>
                <ul style={transForm} className="sign">
                    {isLogged
            ...
            <div className="banners">
                <h1 className="bn_title">Manufacturing,<br /> safety<br /> and quality control<br /> of vaccines</h1>
                <img src="banner.png" />
            </div>
            <div className="container">
                ...
                <div className="row-1 ctn">
                    <img src="pic3.png" />
                    <div className="para">
                        <h2>How it’s made </h2>
                        <p style={overflow1}>Typically, companies will work independently to complete clinical development plans for a vaccine. Once a vaccine is authorized, manufacturing begins to scale up. The antigen (part of the germ that our immune system reacts to)
                            ...
                            together through COVAX to invest in development capacity upfront to streamline the process, as well as to ensure equitable distribution of vaccines. </p>
                        <div className="more" onClick={() => setButton1(false)}>
                            {button1
                                ? <p>more</p>
                                : <p></p>
                            }
                ...
                <div className="row-2 ctn" style={{ background: '#fff' }}>
                    <div className="para">
                        ...
                        <div className="more" onClick={() => setButton2(false)}>
                            {button2
                                ? <p>more</p>
                                : <p></p>
                            }
